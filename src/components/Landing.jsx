...
// --- Static Image URLs (from user uploads) ---
// NOTE: These URLs are placeholders for the actual images accessible in the environment.
const LOGO_URL = 'uploaded:LOGO1.png-fccfe56c-7b6a-458b-b4ab-4db023c597e3';
const STATS_MAP_URL = 'uploaded:Picture1.jpg-f2da2534-8310-4a26-a01a-003a4307d781';
const STATS_CRIMES_URL = 'uploaded:Picture2.jpg-ce7167dd-8383-4b9e-ae78-b4c9b1d4a901';
...
const App = () => {
  ...
  // The distinctive dark blue/indigo color from the logo
  const primaryDark = '#1B243B';
  const accentPink = 'rgb(236, 72, 153)'; // Pink-600
  ...
  // --- Hero Section (Updated UI with Image Placeholder and reduced shadow vibrancy) ---
  const HeroSection = () => (
    <div className={`pt-32 lg:pt-48 pb-28 bg-[${primaryDark}] text-white overflow-hidden relative`}>
      ...
      <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="mt-12 lg:mt-0 flex justify-center lg:justify-end">
            <img 
                src="https://placehold.co/500x400/1E293B/EC4899?text=VigilVave+Wearable+Product" 
    ...
    <section id="target-audience" className="py-24 md:py-36 bg-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-xl text-gray-700 mb-16 max-w-4xl mx-auto">
          VigilVave is designed for **women and girls aged 10–49** across all regions, empowering independence and confidence where it matters most.
        </p>
  ...
  const GroundRealitySection = () => (
    <section id="ground-reality" className={`py-24 md:py-36 bg-[${primaryDark}] text-white`}>
    ...
    <section id="features" className={`py-24 md:py-36 bg-gray-50`}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
                <img 
                    src="https://placehold.co/600x400/F9FAFB/9333ea?text=Discreet+Wearable+on+Wrist" 
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p className="text-xl text-gray-700 mb-8 font-light">
                        VigilVave is committed to empowering women and girls to live confidently and safely in their daily lives. We believe that personal safety should be **seamless, reliable, and stigma-free**.
                    </p>
                ...
                <div className="p-10 rounded-2xl bg-gradient-to-br from-pink-600 to-purple-700 text-white shadow-3xl transform hover:scale-[1.02] transition duration-300">
                    ...
                    <p className="text-lg leading-relaxed text-pink-100">
                        Vigil Vave empowers women in India aged **15-35** with an advanced safety wearable that delivers **protection, peace of mind, health monitoring, and instant emergency response**.
                    </p>
  ...
  const Footer = () => (
    <footer id="contact" className={`bg-[${primaryDark}] text-white py-16`}>
      <div className="container mx-auto px-4">
  ...
  // --- Navigation Bar ---
  const Navbar = () => (
    <header className={`fixed top-0 left-0 w-full z-50 bg-[${primaryDark}]/95 backdrop-blur-sm shadow-xl`}>
      <div className="container mx-auto px-4">
  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased">
      {/* Tailwind CSS Setup - Only necessary for single-file deployment */}
      <script src="https://cdn.tailwindcss.com"></script>
      <style>{`
        /* Custom font import for professional look */
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap');
        body {
            font-family: 'Inter', sans-serif;
            scroll-behavior: smooth;
        }
        /* Custom styles for dynamic colors based on Tailwind classes */
        ...
        /* The custom dark background color */
        .bg-\[#1B243B\] { background-color: #1B243B; }
        .from-\[\#1B243B\] { --tw-gradient-from: #1B243B var(--tw-gradient-from-position); }
